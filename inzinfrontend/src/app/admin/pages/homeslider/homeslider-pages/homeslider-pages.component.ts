...
@Component({
  selector: 'app-homeslider-pages',
  templateUrl: './homeslider-pages.component.html',
  styleUrls: ['./homeslider-pages.component.css']
})
export class HomesliderPagesComponent implements OnInit {
